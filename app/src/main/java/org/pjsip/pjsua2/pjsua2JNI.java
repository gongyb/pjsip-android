...
public class pjsua2JNI {
  ...
  public static void SwigDirector_Call_onCallRxReinvite(Call self, long prm) {
    self.onCallRxReinvite(new OnCallRxReinviteParam(prm, false));
  }
  ...
  public static void SwigDirector_Endpoint_onMediaEvent(Endpoint self, long prm) {
    self.onMediaEvent(new OnMediaEventParam(prm, false));
  }
